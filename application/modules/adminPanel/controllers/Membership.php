...
class Membership extends Admin_Controller {
    ...
    public function get()
    {
        ...
        $this->load->model('membership_model', 'data');
    ...
    public function update($id)
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'GET') {
            ...
            $data['url'] = $this->redirect;
            $data['id'] = $id;
            $data['data'] = $this->main->get($this->table, 'title, price, duration, duration_type, features', ['id' => d_id($id)]);
